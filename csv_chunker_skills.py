...
def process_csv(file_path, max_chars, output_dir):
    ...
    for row_index, row in df.iterrows():
        ...
        for chunk_index, chunk in enumerate(text_chunks):
            ...
            filename = f"{output_dir}/skill_{second_col_value}_of_class_{first_col_value}_row_{row_index}_chunk_{chunk_index}.txt"
...
process_csv(file_path='/Users/kuboi/riku/riku/chunks_src/skills_v0.csv', max_chars=2000, output_dir='/Users/kuboi/riku/riku/chunks_1/skills_1/')